...
export const CandleStickChartComponent = () => {
  return (
    <CandleStickChart
        ...
        dataSets: [
          {
            ...
            config: {
              increasingColor: processColor('#18B964'),
              increasingPaintStyle: 'FILL',
              decreasingColor: processColor('#EC4B32'),
      ...
      xAxis={{position: 'BOTTOM', textColor: processColor('#ffffff')}}
      marker={{enabled: false}}
      maxVisibleValueCount={0}
      autoScaleMinMaxEnabled={false}
      chartDescription={{text: ''}}></CandleStickChart>
  );
};
